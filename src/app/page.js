    ...
    <div class="homepage">
      <div class="body">
        ...
        <div class="homepage-title-container">
          <h2>Registration for the 2025 CSA is now open</h2>
          ...
          <div class="col-8 csa-details">
            <div class="What-to-expect">
              ...
              <ul>
                ...
                <li><b>Half Share - $275</b></li>
                <li>12 weeks of produce (every other week) ~ $23 per week ~ $2.85 per item</li>
              </ul>
            </div>
            <div class="Logistics">
              <h3>Logistics</h3>
      ...
      <section ref={aboutRef} class="about">
        ...
        <div class="about-content">
          ...
          {/* <img class="homepage-image" src="/HH_Hompage_Image.png"/> */}
          <p>After Henry’s Farm, I decided that growing vegetables is what I wanted to do with my life, but how to start? Without land, equipment, or any kind of infrastructure, it still did not seem possible. I considered working and saving up to someday start something. Luckily, I did not have to wait. A family just North of Dexter and 3 miles from where I’ve grown up has provided the best situation possible. Land, a tractor, utilities, and some really cool pets too. Best of all, it’s centered in a community of like-minded people.</p>
          <p>There’s no question whether the vegetables from a local farm beats what’s in the supermarket, but is it worth the higher price-tag? I want to make that decision a no-brainer by growing the highest quality produce and offering the best value to as many people as possible. High quality produce to me means it’s high in nutrients, free of toxins, and great in taste. Visual appeal and customer experience is also important to me. You may find the occasional cabbage worm, but the produce should never be a dirty mess or riddled with bugs.</p>
        </div>
      </section>
