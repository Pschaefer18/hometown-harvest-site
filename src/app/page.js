  ...
  return (
    ...
    <div class="homepage">
      ...
      <section ref={aboutRef} class="about">
        ...
        <p>There’s no question that the vegetables from a local farm beat what’s in the supermarket, but is it worth the higher price tag? We want to make that decision a no-brainer by growing the highest quality produce and offering the best value to as many people as possible. High-quality produce to us means it’s nutrient-rich, free of toxins, and bursting with flavor. Visual appeal and customer experience are also important. You may find the occasional bad leaf, but the produce should never be a dirty mess or riddled with bugs.</p>
          <h4>Paul Schaefer</h4>
          <p>I began thinking about being a vegetable farmer at around 15, but wasn't sure how realistic it was. I knew that I at least wanted to grow my own vegetables and liked the idea of making it my source of income. While working at a nearby, small farm over the summer in high school, I experienced the difference in food you grow yourself vs the food bought at the supermarket. An heirloom tomato grown with limited watering and fertilizer offered a lot more flavor than the tomatoes I was used to. My life had been a lie. At 19, I went and did a nine-month apprenticeship on <a href="https://www.henrysfarm.com/" target="_ blank">Henry's Farm</a> in Congerville, Illinois. Henry is a real farmer and growing organic vegetables on a small scale is all he’s ever done for a living. Henry also works nearly 100 hours a week and leaves for the Saturday market at 1:00 AM.</p>
          {/* <img class="homepage-image" src="/HH_Hompage_Image.png"/> */}
